...
func TestDay4Examples(t *testing.T) {
	runs := []struct {
		name      string
		input     string
		expected  int64
		...
		{"Part 1", "aa bb cc dd ee\naa bb cc dd aa\naa bb cc dd aaa", 2, Day4Part1IsValid},
		{"Part 2", "abcde fghij\nabcde xyz ecdab\na ab abc abd abf abj\niiii oiii ooii oooi oooo\noiii ioii iioi iiio", 3, Day4Part2IsValid},
	}

	for _, r := range runs {
		t.Run(r.name, func(t *testing.T) {
			out := Day4(r.input, r.validFunc)

			if out != r.expected {
				t.Errorf("Expected %v, got %v for input %q", r.expected, out, r.input)
			}
		})
	}
}

func TestDay4IsValidExamples(t *testing.T) {
	runs := []struct {
		name string
		input    string
		expected bool
		...
		{"Part 1 example 1", "aa bb cc dd ee", true, Day4Part1IsValid},
		{"Part 1 example 2", "aa bb cc dd aa", false, Day4Part1IsValid},
		{"Part 1 example 3", "aa bb cc dd aaa", true, Day4Part1IsValid},
		{"Part 2 example 1", "abcde fghij", true, Day4Part2IsValid},
		{"Part 2 example 2", "abcde xyz ecdab", false, Day4Part2IsValid},
		{"Part 2 example 3", "a ab abc abd abf abj", true, Day4Part2IsValid},
		{"Part 2 example 4", "iiii oiii ooii oooi oooo", true, Day4Part2IsValid},
		{"Part 2 example 5", "oiii ioii iioi iiio", false, Day4Part2IsValid},
	}

	for _, r := range runs {
		t.Run(r.name, func(t *testing.T) {
			out := r.validFunc(r.input)
...
func TestDay4Part1Input(t *testing.T) {
	...
	out := Day4(input, Day4Part1IsValid)

	if out != expected {
		t.Errorf("Expected %v, got %v for input %q", expected, out, input)
	}
}
...
func TestDay4Part2Input(t *testing.T) {
	...
	out := Day4(input, Day4Part2IsValid)
...
const day4Input = `nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
